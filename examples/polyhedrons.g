...
#! [ [ [ 5, 0 ], [ 4, -1 ], [ 4, 0 ], [ 4, 1 ], [ 3, 0 ], [ 3, 1 ], [ 3, 2 ],
#! [ 2, 1 ], [ 2, 2 ], [ 2, 3 ], [ 1, 2 ], [ 1, 3 ], [ 1, 4 ], [ 0, 3 ], 
#! [ 0, 4 ], [ 0, 5 ], [ 0, 6 ] ], [  ], [ [ 1, 2 ] ] ]
LatticePoints( MainPolytope( Q ) );
#! [ [ 0, 3 ], [ 0, 4 ], [ 0, 5 ], [ 0, 6 ], [ 1, 2 ], [ 1, 3 ], [ 1, 4 ], [ 2, 1 ],
#! [ 2, 2 ], [ 2, 3 ], [ 3, 0 ], [ 3, 1 ], [ 3, 2 ], [ 4, -1 ], [ 4, 0 ], [ 4, 1 ], 
#! [ 5, 0 ] ]
Dimension( Q );
#! 2
...
#! ###########################################################################
#! #
#! # We know that 4x + 6y = 3 does not have any solutions because 
...
#! # So the solutions set is { [ -6, 5 ] + t_1*[ -1, 2 ] + t_2*[ -5, 0 ] }
#! # where t_1,t_2 are integers. 
